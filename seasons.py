...
# number of games, and goal average
# readSeasonDataFrame(df_0910, len(df_0910), season_0910)
# readSeasonDataFrame(df_1011, len(df_1011), season_1011)
# readSeasonDataFrame(df_1112, len(df_1112), season_1112)
# readSeasonDataFrame(df_1213, len(df_1213), season_1213)
# readSeasonDataFrame(df_1314, len(df_1314), season_1314)
# readSeasonDataFrame(df_1415, len(df_1415), season_1415)
# readSeasonDataFrame(df_1516, len(df_1516), season_1516)
# readSeasonDataFrame(df_1617, len(df_1617), season_1617)
# readSeasonDataFrame(df_1718, len(df_1718), season_1718)
# readSeasonDataFrame(df_1819, len(df_1819), season_1819)
